![Rancher + Let's Encrypt = Awesome Sauce](https://raw.githubusercontent.com/winterlightlabs/rancher-letsencrypt/master/hero.png)

# Let's Encrypt Certificate Manager for Rancher

[![Latest Version](https://img.shields.io/github/release/winterlightlabs/rancher-letsencrypt.svg?maxAge=8600)][release]
[![Circle CI](https://circleci.com/gh/winterlightlabs/rancher-letsencrypt.svg?style=shield&circle-token=cd06c9a78ae3ef7b6c1387067c36360f62d97b7a)][circleci]
[![Docker Pulls](https://img.shields.io/docker/pulls/winterlightlabs/rancher-letsencrypt.svg?maxAge=8600)][hub]
[![License](https://img.shields.io/github/license/winterlightlabs/rancher-letsencrypt.svg?maxAge=8600)]()

[release]: https://github.com/winterlightlabs/rancher-letsencrypt/releases
[circleci]: https://circleci.com/gh/winterlightlabs/rancher-letsencrypt
[hub]: https://hub.docker.com/r/winterlightlabs/rancher-letsencrypt/
